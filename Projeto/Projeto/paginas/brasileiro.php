      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center my-4">
            <h1 class="display-3">Mate Brasileiro(Chimarrão)</h1>
            <h4>A bebida com erva mate padrão brasileiro</h4>


            <p>O chimarrão, ou mate, é uma bebida característica da cultura do sul da América do Sul legada pelas culturas indígenas caingangue, guarani, aimará e quíchua.
             É composto por uma cuia, uma bomba, erva-mate moída e água a aproximadamente 70 graus Celsius.</p>
          </div>
        </div>
        <!-- <div class="row">
          <div class="col-3"></div>
